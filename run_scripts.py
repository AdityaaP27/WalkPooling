...
data1 = ["USAir", "NS", "Power", "Celegans", "Router", "PB", "Ecoli", "Yeast"]
for data in data1:
    for i in range(1,11):
...
for data_name in data2:
    for feature in feature_set:
        for i in range(1,11):
            ...
            call2 = "python src/main.py --seed " + str(i) + " --log " + str(i) + " --data-name " + data_name + " --drnl 0 --init-attribute None --init-representation $4 --embedding-dim 32"        
            cmd_call2 = call2.split(' ')
            subprocess.call2(cmd_call2, shell=True)
